...
<div style="display: inline-block; padding: 15px 30px; background: #e3f2fd; border: 2px solid #2196f3; border-radius: 8px; margin-bottom: 10px;">
<strong>Frontend (Vue 3)</strong>
</div>
</div>

<div style="text-align: center; margin: 10px 0; color: #666;">
↓ HTTP POST /api/v1/chat<br>
{user_id, query}
</div>

<div style="background: #f5f5f5; border: 2px solid #757575; border-radius: 8px; padding: 20px; margin: 20px auto; max-width: 800px;">
<div style="text-align: center; font-weight: bold; margin-bottom: 15px; color: #424242;">Backend (FastAPI)</div>

<div style="background: white; border: 1px solid #bdbdbd; border-radius: 6px; padding: 12px; margin: 10px 0;">
<strong>router.py</strong><br>
• 세션 관리<br>
• 요청 검증
</div>

<div style="text-align: center; margin: 8px 0; color: #666;">↓</div>

<div style="background: white; border: 1px solid #bdbdbd; border-radius: 6px; padding: 12px; margin: 10px 0;">
<strong>chatting.py</strong><br>
• 맥락 분석<br>
• RAG 파이프라인 호출
</div>
...
<div style="background: white; border: 1px solid #bdbdbd; border-radius: 6px; padding: 12px; margin: 10px 0;">
<strong>llm_handler.py</strong><br>
• 질문 재구성<br>
• 멀티쿼리 생성<br>
• 답변 생성
</div>
...
<div style="text-align: center; margin: 20px 0;">
<div style="display: inline-block; padding: 15px 30px; background: #fff3e0; border: 2px solid #ff9800; border-radius: 8px;">
<strong>PostgreSQL + pgvector</strong><br>
• announcements<br>
• announcement_files<br>
...
<div style="font-family: 'Courier New', monospace; line-height: 1.8; max-width: 600px; margin: 0 auto;">

<div style="background: #e8f5e9; border-left: 4px solid #4caf50; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>1. 웹 크롤링 (LH 공고)</strong>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #e8f5e9; border-left: 4px solid #4caf50; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>2. CSV 저장</strong><br>
<span style="color: #666; font-size: 0.9em;">공고 메타데이터</span>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>3. PostgreSQL 임포트</strong><br>
<span style="color: #666; font-size: 0.9em;">announcements 테이블</span>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #fff3e0; border-left: 4px solid #ff9800; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>4. PDF 다운로드</strong>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #fce4ec; border-left: 4px solid #e91e63; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>5. 텍스트 추출</strong><br>
<span style="color: #666; font-size: 0.9em;">pymupdf4llm</span>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #f3e5f5; border-left: 4px solid #9c27b0; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>6. 마크다운 변환</strong>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #e0f2f1; border-left: 4px solid #009688; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>7. 텍스트 청킹</strong><br>
<span style="color: #666; font-size: 0.9em;">SmartChunker</span>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #fff9c4; border-left: 4px solid #fbc02d; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>8. 임베딩 생성</strong><br>
<span style="color: #666; font-size: 0.9em;">BAAI/bge-m3</span>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px 16px; margin: 8px 0; border-radius: 4px;">
<strong>9. PostgreSQL 저장</strong><br>
<span style="color: #666; font-size: 0.9em;">document_chunks 테이블</span>
</div>

<div style="text-align: center; margin: 5px 0; color: #666;">↓</div>

<div style="background: #c8e6c9; border-left: 4px solid #4caf50; padding: 12px 16px; margin: 8px 0; border-radius: 4px; font-weight: bold;">
<strong>10. 벡터화 완료 표시</strong><br>
<span style="color: #666; font-size: 0.9em;">is_vectorized = true</span>
</div>
